...
public class Python3Parser extends Parser {
	...
	public static final int
		...
		RULE_expr_stmt = 4, RULE_test = 5, RULE_compound_stmt = 6, RULE_funcdef = 7, 
		RULE_parameters = 8, RULE_suite = 9;
	private static String[] makeRuleNames() {
		return new String[] {
			"file_input", "stmt", "simple_stmt", "small_stmt", "expr_stmt", "test", 
	...
	public final File_inputContext file_input() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 3644L) != 0)) {
				{
				setState(22);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
		...
		try {
			...
			case NEWLINE:
				...
				do {
					...
					_errHandler.sync(this);
					_la = _input.LA(1);
				} while ( (((_la) & ~0x3f) == 0 && ((1L << _la) & 1596L) != 0) );
				setState(65);
				match(DEDENT);
				}
				break;
